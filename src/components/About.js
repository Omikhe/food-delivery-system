        ...
        <>
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <p className="text-gray-700 mb-8">
                    Welcome to Chirunga Munchies, your go-to food delivery service designed specifically for MUBAS students and the surrounding Blantyre area. We understand the daily challenges you face balancing academics and campus life, which is why we're dedicated to providing a convenient solution for satisfying your hunger cravings.
                </p>

                <h1 className="text-3xl font-bold mb-4">Our Mission</h1>
                <p className="text-gray-700 mb-8">
                    At Chirunga Munchies, our mission is to revolutionize the way MUBAS students and nearby Blantyre residents access food. We strive to create a seamless and hassle-free dining experience that fits perfectly into your busy schedule. Whether you're studying late into the night or rushing between classes, we're here to ensure you never go hungry.
                </p>


                <p className="text-gray-700 mb-4 font-bold">How It Works</p>
                <p className="text-gray-700 mb-8">
                    Getting delicious meals delivered to your doorstep has never been easier. Simply sign up for a Chirunga Munchies account and log in to explore our curated selection of food providers near MUBAS and around Blantyre. With just a few taps, you can browse menus, place orders, and track deliveries right from your smartphone or computer.
                </p>
                ...
                <p className="text-gray-700 mb-8">
                    Chirunga Munchies was founded by a team of passionate MUBAS students who saw an opportunity to improve campus dining. With a diverse range of skills and expertise, we're committed to delivering a superior food delivery experience tailored to the needs of our fellow students and the surrounding Blantyre community.
                </p>


                <h1 className="text-3xl font-bold mb-4">Get Started Today</h1>
                <p className="text-gray-700 mb-8">
                    Ready to satisfy your cravings with Chirunga Munchies? Sign up now and discover a world of delicious possibilities right at your fingertips. Whether you're in the mood for a quick snack or a hearty meal, we've got something for everyone. Join us in redefining campus dining for MUBAS students and the Blantyre community, and make your next meal a memorable one with Chirunga Munchies!
                </p>
